  ...
  <Paper style={styles.footer} zDepth={3} >
    <div className="footer-col">
      <List>
        ...
        <a target="_blank" href="https://www.expensify.com/signin"> < ListItem innerDivStyle={{paddingTop: '8px', fontSize: '14px', paddingBottom: '8px'}} primaryText={"Expensify"} /> </a>
        <a target="_blank" href="https://my.vanguardplan.com/"> < ListItem innerDivStyle={{paddingTop: '8px', fontSize: '14px', paddingBottom: '8px'}} primaryText={"Vanguard"} /> </a>
      </List>
    </div>
    <div className="footer-col">
      <List>
        <Subheader style={{color: 'lightgrey'}} > General </Subheader>
        <a target="_blank" href="https://factual.namely.com/"> < ListItem innerDivStyle={{paddingTop: '8px', fontSize: '14px', paddingBottom: '8px'}} primaryText={"Namely"} /> </a>
        <a target="_blank" href="http://wiki.corp.factual.com/"> < ListItem innerDivStyle={{paddingTop: '8px', fontSize: '14px', paddingBottom: '8px'}} primaryText={"Confluence"} /> </a>     
      </List>
    </div>
    <div className="footer-col">
      <List>
